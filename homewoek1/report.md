...
相比迴圈模擬，遞迴寫法更貼近數學定義，可直接對應 powerset 問題的決策樹展開方式，利於步驟追蹤與除錯，讓整體邏輯更直觀。

#### (註:此作業在2025.07.22 09:14就已經交了，ulearn作業裡面的上傳github連結可證明，只是為了排版把所有作業一的檔案轉移到這個新的資料夾裡面，其餘均無異動)
